...
# 二、本项目相关
本项目是对我的个人网站对应的后台管理系统，使用前后分离的方式构建。前(angular2)+后(spring boot)共同打造。
...
3. @[spring boot](http://docs.spring.io/spring-boot/docs/current/reference/html/)，微服务框架最好的选择。省去了诸多配置烦恼。
4. @其他所有对我有帮助的人和事情。
...
5. 本项目地址: http：// xiaomo.info/admin
